...
1. 电容与电感又称为储能元件
2. **电容**：一种可以在电场中储存电能的无源元件
3. 一个电容包括两个导电板，中间由电介质隔开，导电板通常由铝箔制成，电介质由空气、陶瓷、纸或云母充当
4. 电容的**容量**是电容的一个导电板所携带的电荷与两个导电板之间的电压的比值，单位为法拉（F）
   1. q = Cv
   2. 1F = 1C/V
5. 电容常数C取决于电容器的物理参数
6. 电容器可以用来：阻直流、通交流、调整相位、存储能量、发动电机、抑制噪声
7. 线性电容：i = C(dv/dt)，w = 1/2Cv^2
8. 电容对于直流电路来说是开路
9. 电容上的电压不会产生突变（电容会阻止阶跃电压对其充电）
10. 理想电容不会消耗能量
11. 并联电容的等效电容是各个电容的和
12. 串联电容的等效电容是每个电容倒数之和的倒数
13. **电感**：可以利用其磁场储存能量的无源器件
14. 电感应用于：电力供应、变压器、无线电、电视机、雷达、电动机
15. 任何有电流通过的导线都有感应特性
16. 电感由导线绕成的线圈组成
17. **电感系数**：电感在电流改变的情况下产生的特性，单位为亨利（H）
    1. v = L(di/dt)
    2. 1H = 1V*s/A
    3. w = 1/2Li^2
18. 要使电感两端有电压，其电流必须随时间变化
19. 恒定电感电流，v = 0
20. 感应系数取决于它的实际尺寸及其导电性能
21. 在直流电路中，电感相当于短路
22. 通过电感的电流不能发生瞬时改变
23. 理想电感不消耗能量
24. 串联电感的等效电感系数是各电感的感应系数之和
25. 并联电感的等效电感系数是每个电感的感应系数倒数和的倒数